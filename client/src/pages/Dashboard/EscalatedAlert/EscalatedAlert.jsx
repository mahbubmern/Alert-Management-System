...
const EscalatedAlert = () => {
  ...
  //       // true if assignedTo has any Level_2
  //       const hasLevel2 =
  //         Array.isArray(item.assignedTo) &&
  //         item.assignedTo.some((a) => a?.role === "Level_2");

  //       // show only escalated alerts where NO Level_2 is assigned
  //       return item.status === "escalated" && !hasLevel2;
  //     });
  ...
  // FETCH FUNCTION
  const fetchEscalatedAlerts = async () => {
    try {
      setLoading(true);
      // CALL THE NEW API WITH view="escalated"
  ...
  return (
    <>
      <Title title={"SEM | Escalated Alert"} />
      ...
      <div className="bg-gray-900 text-gray-200 min-h-screen  font-sans py-12">
        <main className="p-8">
          ...
          <div className="flex items-center gap-2 !pt-3 pb-3 !rounded-t">
            ...
            <Rotate3d className="h-6 w-6 ml-2.5 text-cyan-400" />
          </div>
                        ...
                        data.map((item, index) => (
                          ...
                          >
                            ...
                            <td className="py-1 px-2">
                              <span
                                className={`inline-block text-[11px] sm:text-xs font-semibold px-2 py-1 rounded-full ${
                            ...
                            <td className="py-2 px-1 flex gap-1">
                              <button
                                ...
                                className="bg-amber-600 hover:bg-amber-800 text-white text-xs px-2 py-1  flex items-center gap-1 cursor-pointer"
                              >
                              ...
                              >
                                <i className="fa fa-line-chart"></i> View Alert
                              </button>
                            </td>
                          </tr>
                        ))
        ...
        >
          ...
          <div className="bg-gray-900 text-gray-200 rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-y-auto p-6 relative mt-5">
            ...
            <div className="flex justify-between items-center border-b border-amber-600 pb-2">
              <h6 className="text-lg font-semibold text-white">View Alert</h6>
              <button
                onClick={closeModal}
                      ...
                      <div className="print-container">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                          ...
                          <div>
                            ...
                            {formatDateTimeReadable(input.acceptedTime)}
                          </div>
                          <div>
                        ...
                        <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                          <div>
                            ...
                            {formatDateTimeReadable(input.eventTime)}
                          </div>
                          <div>
